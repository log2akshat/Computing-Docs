...
This repo contains the code for creating and maintaining Computing Docs written by me on trac wiki. This code is ready to be deployed on RedHat OpenShift environment. This repo also contains the Database backup of Computing Docs wiki where I have documented all the major software and hardware Installations and Configurations on which I have worked.
